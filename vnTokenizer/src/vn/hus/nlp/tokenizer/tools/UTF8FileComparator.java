...
public final class UTF8FileComparator {
	...
	String secondFile;
	/**
	 * The third file that contains differences of the two files first and
	 * second.
	 */
	String thirdFile;
	...
	public String[] compare() {
		...
		int min = (firstLines.length < secondLines.length ? firstLines.length : secondLines.length);
		for (int i = 0; i < min; i++) {
	...
	public static void main(String[] args) {
		UTF8FileComparator comparator = new UTF8FileComparator("corpus/test/corpus0_tok_ambiguities.txt", "corpus/test/corpus0_tok_resolved.txt", "corpus/test/corpus0_tok_differences.txt");
		comparator.compare();
