 ...
 *         Jul 15, 2009, 2:18:40 PM <br>
 *         This extractor extracts set of words from a manually tagged corpus.
 *         This utility is used to enrich the dictionary of the tokenizer.
 */
public class WordExtractor {
	...
	/**
	 * Gets the words of a tagged sentence. In the tagged sentence, word/tag
	 * pairs are separated by space characters.
	 * 
