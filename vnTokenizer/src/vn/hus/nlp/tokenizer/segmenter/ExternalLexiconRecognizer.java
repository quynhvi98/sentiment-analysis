 ...
 *         <p>
 *         An additional lexicon recognizer which recognises an external lexicon
 *         provided by users in case they want to use a custom lexicon (in
 *         addition with the internal lexicon of the tokenizer).
 */
public class ExternalLexiconRecognizer extends AbstractLexiconRecognizer {
	 ...
	 * 
	 * @see
	 * vn.hus.nlp.tokenizer.segmenter.AbstractLexiconRecognizer#accept(java.
	 * lang.String)
	 */
	@Override
