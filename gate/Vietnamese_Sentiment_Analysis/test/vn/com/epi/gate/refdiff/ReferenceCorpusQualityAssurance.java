 ...
 *
 *  $Id: ReferenceCorpusQualityAssurance.java 13121 2010-10-06 12:52:51Z thomas_heitz $
 */
 ...
 */
@CreoleResource(name = "Reference Corpus Quality Assurance", guiType = GuiType.LARGE,
    resourceDisplayed = "gate.Corpus", mainViewer = false,
    helpURL = "http://gate.ac.uk/userguide/sec:eval:corpusqualityassurance")
public class ReferenceCorpusQualityAssurance extends AbstractVisualResource
  ...
  protected void readSetsTypesFeatures(final int documentStart) {
    ...
    ReferenceCorpusQualityAssurance.this.setCursor(
  ...
  protected void compareAnnotation() {
    ...
    for (int row = 0; row < corpus.size(); row++) {
      ...
      if (measuresType == FSCORE_MEASURES) {
        ...
        HashMap<String, ReferenceAnnotationDiffer> differsByType =
          new HashMap<String, ReferenceAnnotationDiffer>();
        ...
        for (String type : types) {
          ...
          differ = new ReferenceAnnotationDiffer(document, referenceSet);
        ...
        differ = new ReferenceAnnotationDiffer(differsByType.values());
        List<String> measuresRow;
        if (useBdm) {
        	throw new UnsupportedOperationException();
        	/* ngocminh.oss - don't use ontology measures
    ...
    if (measuresType == FSCORE_MEASURES) {
      for (String type : types) {
        ArrayList<ReferenceAnnotationDiffer> differs = new ArrayList<ReferenceAnnotationDiffer>();
        for (HashMap<String, ReferenceAnnotationDiffer> differsByType :
        ...
        if (useBdm) {
          ...
          ReferenceAnnotationDiffer differ = new ReferenceAnnotationDiffer(differs);
    ...
    if (measuresType == FSCORE_MEASURES) {
      if (useBdm) {
        ...
        List<ReferenceAnnotationDiffer> differs = new ArrayList<ReferenceAnnotationDiffer>();
        for (Map<String, ReferenceAnnotationDiffer> differsByType :
              differsByDocThenType) {
  ...
  protected void printSummary(Object measureObject,
    ...
    ReferenceAnnotationDiffer differ = null;
    ClassificationMeasures classificationMeasures = null;
    OntologyMeasures ontologyMeasures = null;
    if (measureObject instanceof ReferenceAnnotationDiffer) {
      differ = (ReferenceAnnotationDiffer) measureObject;
    ...
    if (measureObject instanceof OntologyMeasures) {
      ...
      differ = new ReferenceAnnotationDiffer(differs);
    	 */
    }
  ...
  protected class SetBdmFileAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent evt) {
      ...
      fileChooser.setResource(
        ReferenceCorpusQualityAssurance.class.getName() + ".BDMfile");
      int res = fileChooser.showOpenDialog(ReferenceCorpusQualityAssurance.this);
  ...
  class OpenAnnotationDiffAction extends AbstractAction{
    ...
    public void actionPerformed(ActionEvent e){
      ...
      ReferenceAnnotationDiffGUI frame = new ReferenceAnnotationDiffGUI("Annotation Difference",
  ...
  protected class ExportToHtmlAction extends AbstractAction{
    ...
    public void actionPerformed(ActionEvent evt){
      ...
      fileChooser.setResource(ReferenceCorpusQualityAssurance.class.getName());
      int res = fileChooser.showSaveDialog(ReferenceCorpusQualityAssurance.this);
      if (res != JFileChooser.APPROVE_OPTION) { return; }
      ...
      try{
        ...
        JOptionPane.showMessageDialog(ReferenceCorpusQualityAssurance.this,
  ...
  protected class HelpAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
      MainFrame.getInstance().showHelpFrame(
        ...
        ReferenceCorpusQualityAssurance.class.getName());
    }
  }
   ...
   *  then contains (annotation type * ReferenceAnnotationDiffer) */
  protected ArrayList<HashMap<String, ReferenceAnnotationDiffer>> differsByDocThenType =
    new ArrayList<HashMap<String, ReferenceAnnotationDiffer>>();
  ...
  protected Timer timer = new Timer("ReferenceCorpusQualityAssurance", true);
